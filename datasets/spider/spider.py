...
def preprocess(dataset, data_training_args, tokenizer):
...
def load(tokenizer):
    ...
    train_dataset = preprocess(train_dataset, data_training_args, tokenizer)
    validation_dataset = preprocess(validation_dataset, data_training_args, tokenizer)
